...
to https://github.com/jzmiller1/public-django-app-template
"""
import os
import subprocess
import sys
...
def _configure_git():
    ...
    _shell('git config --local user.email "zac@informatical.info"')
    _shell('git config --local user.name "Zac Miller"')
